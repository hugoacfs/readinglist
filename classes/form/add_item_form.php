...
class add_item_form extends \moodleform {
    ...
    function definition() {
        ...
        $mform->addElement('text', 'title', get_string('form_title', 'mod_readinglist'),
            ['size' => '30', 'maxlength' => '255']);
        $mform->setType('title', PARAM_TEXT);
        $mform->addRule('title', null, 'required', null, 'client');
        // Item url for mdl_readinglist_item
        $mform->addElement('text', 'url', get_string('form_url', 'mod_readinglist'),
            ['size' => '30', 'maxlength' => '255']);
        $mform->setType('url', PARAM_URL);
        // Item publish year for mdl_readinglist_item
        $mform->addElement('text', 'year', get_string('form_yearofpublish', 'mod_readinglist'),
            ['size' => '30', 'maxlength' => '255']);
    ...
    function display_book_form($form) {
        ...
        // ISBN
        $form->addElement('text', 'isbn', get_string('form_isbn', 'mod_readinglist'),
            ['size' => '30', 'maxlength' => '255']);
        $form->setType('isbn', PARAM_TEXT);
        // Edition
        $form->addElement('text', 'edition', get_string('form_edition', 'mod_readinglist'),
            ['size' => '30', 'maxlength' => '255']);
        $form->setType('edition', PARAM_TEXT);
        // Page Range
        $form->addElement('text', 'pagerange', get_string('form_pagerange', 'mod_readinglist'),
            ['size' => '30', 'maxlength' => '255']);
        $form->setType('pagerange', PARAM_TEXT);
        // Chapter
        $form->addElement('text', 'chapter', get_string('form_chapter', 'mod_readinglist'),
            ['size' => '30', 'maxlength' => '255']);
    ...
    function display_article_form($form) {
        $form->addElement('header', 'general', get_string('form_additionalinfo', 'mod_readinglist'));
        // journal
        $form->addElement('text', 'journal', get_string('form_journal', 'mod_readinglist'),
            ['size' => '30', 'maxlength' => '255']);
        $form->setType('journal', PARAM_TEXT);
        // volume
        $form->addElement('text', 'volume', get_string('form_volume', 'mod_readinglist'),
            ['size' => '30', 'maxlength' => '255']);
        $form->setType('volume', PARAM_TEXT);
        // issue
        $form->addElement('text', 'issue', get_string('form_issue', 'mod_readinglist'),
            ['size' => '30', 'maxlength' => '255']);
        ...
        $form->setType('pagerange', PARAM_TEXT);
        // doi
        $form->addElement('text', 'doi', get_string('form_doi', 'mod_readinglist'),
            ['size' => '30', 'maxlength' => '255']);
    ...
    function display_website_form($form) {
        ...
        $form->addElement('header', 'general', get_string('form_additionalinfo', 'mod_readinglist'));
        // name
        $form->addElement('text', 'name', get_string('form_websitename', 'mod_readinglist'),
            ['size' => '30', 'maxlength' => '255']);
